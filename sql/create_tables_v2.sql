...
CREATE TABLE `kline_d_v` (
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_D_V_IDX1` (`code`,`date`),
  KEY `KLINE_D_V_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Daily Kline Basic Validation Data'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_d_v_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `amount` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_D_V_LR_IDX1` (`code`,`date`),
  KEY `KLINE_D_V_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Daily Kline Log Return (Validation)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_d_v_ma` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_D_V_MA_IDX1` (`code`,`date`),
  KEY `KLINE_D_V_MA_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Daily Kline Moving Average (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_d_v_ma_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_D_V_MA_LR_IDX1` (`code`,`date`),
  KEY `KLINE_D_V_MA_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Daily Kline Moving Average Log Return (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;
...
CREATE TABLE `kline_m_v` (
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_M_V_IDX1` (`code`,`date`),
  KEY `KLINE_M_V_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Monthly Kline (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_m_v_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `amount` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_M_V_LR_IDX1` (`code`,`date`),
  KEY `KLINE_M_V_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Monthly Kline Log Return (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_m_v_ma` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_M_V_MA_IDX1` (`code`,`date`),
  KEY `KLINE_M_V_MA_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Monthly Kline Moving Average (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_m_v_ma_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_M_V_MA_LR_IDX1` (`code`,`date`),
  KEY `KLINE_M_V_MA_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Monthly Kline Moving Average Log Return (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;
...
CREATE TABLE `kline_w_v` (
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_W_V_IDX1` (`code`,`date`),
  KEY `KLINE_W_V_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Weekly Kline (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_w_v_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `amount` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_W_V_LR_IDX1` (`code`,`date`),
  KEY `KLINE_W_V_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Weekly Kline Log Return (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_w_v_ma` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_W_V_MA_IDX1` (`code`,`date`),
  KEY `KLINE_W_V_MA_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Weekly Kline Moving Average (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;

CREATE TABLE `kline_w_v_ma_lr` (
  `code` varchar(8) NOT NULL,
  `date` varchar(20) NOT NULL,
  `klid` int NOT NULL,
  `ma5` double DEFAULT NULL,
  ...
  `utime` varchar(8) DEFAULT NULL COMMENT 'Last update time',
  PRIMARY KEY (`code`,`klid`),
  UNIQUE KEY `KLINE_W_V_MA_LR_IDX1` (`code`,`date`),
  KEY `KLINE_W_V_MA_LR_DATE` (`date`,`klid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=COMPRESSED COMMENT='Weekly Kline Moving Average Log Return (Validate)'
/*!50100 PARTITION BY KEY (`code`)
PARTITIONS 1024 */;
