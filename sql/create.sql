...
CREATE TABLE `indicator_d` (
  ...
  `RSI1` decimal(6,3) DEFAULT NULL,
  `RSI2` decimal(6,3) DEFAULT NULL,
  `RSI3` decimal(6,3) DEFAULT NULL,
  `BIAS1` decimal(6,3) DEFAULT NULL,
  `BIAS2` decimal(6,3) DEFAULT NULL,
  `BIAS3` decimal(6,3) DEFAULT NULL,
  `udate` varchar(10) DEFAULT NULL COMMENT '更新日期',
  `utime` varchar(8) DEFAULT NULL COMMENT '更新时间',
